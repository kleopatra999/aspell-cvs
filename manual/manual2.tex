...
This allows which characters contained in a text will be used to switch contexts and which will be assumed normal characters.
The two delimiting chars belonging to one pair have to be separated by a space character.
...
If the end of line delimits a context than this has to be indicated by \verb#\0#.
\end{description}
\end{description}
...
This is done by passing +e <\,{}expr\,{}> to config command of Aspell.
If +e is the only argument to config Aspell assumes +e all which lists the configuration of all installed and reachable filters.
